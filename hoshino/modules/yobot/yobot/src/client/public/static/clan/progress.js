...
var vm = new Vue({
    ...
    methods: {
        ...
        csummary: function (cha) {
            ...
            if(cha.message)leaveMsg=cha.message;else leaveMsg='';
            return `(${cha.cycle}-${cha.boss_num}) <a class="digit${cha.damage.toString().length}">${cha.damage}</a>&nbsp;<b class="leaveMsg">`+leaveMsg+`</b>&nbsp;`;
        },
